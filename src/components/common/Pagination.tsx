...
const buttonBase =
  'focus-ring inline-flex h-9 min-w-9 cursor-pointer items-center justify-center rounded-md border border-transparent px-2 text-sm select-none disabled:pointer-events-none disabled:opacity-40'
